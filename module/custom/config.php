...
$config->custom->fieldList['task']['create']         = 'module,story,pri,assignedTo,estimate,desc,estStarted,deadline,complexity';
$config->custom->fieldList['task']['edit']           = 'module,pri,assignedTo,estimate,estStarted,deadline,complexity';
