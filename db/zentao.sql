...
CREATE TABLE IF NOT EXISTS `zt_ai_teammate` (
  ...
  `desc` text DEFAULT NULL COMMENT '员工描述',
...
CREATE TABLE IF NOT EXISTS `zt_ai_task` (
  ...
  `chatID` mediumint(8) unsigned NOT NULL DEFAULT 0 COMMENT '对话 ID。任务未被队列处理时为 0, 重新处理时会创建新对话并更新此 ID',
...
CREATE TABLE IF NOT EXISTS `zt_ai_chat` (
  ...
  `task` mediumint(8) unsigned NOT NULL DEFAULT 0 COMMENT '当类型为 task 时，对应的 AI 任务 ID',
